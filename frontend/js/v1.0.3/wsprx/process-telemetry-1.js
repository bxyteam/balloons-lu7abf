...
function renderTelemetryTablePaginated(containerId = "telemetry1-table", defaultRowsPerPage = 100) {
  ...
  if (!Array.isArray(AppState.telemetry.tele1Filtered) || AppState.telemetry.tele1Filtered.length === 0) {
    container.innerHTML = `<p style="font-weight: 600; color: #2d3748;font-size: 14px;padding: 0 12px;">No telemetry 1 data available. Telemetry 1 skipped.</p>`;
    return;
  }
