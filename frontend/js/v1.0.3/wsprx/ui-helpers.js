...
function setNoChartsMapLayout() {
   document.querySelector('#tables-container').style.height = 'auto';
   document.querySelector('#iconos').style.visibility = 'hidden';
   document.querySelector('#menu-map-toggle').style.display = 'none';
   document.querySelector('#map-container').style.height = '5dvh';
   document.querySelector('#map-container').style.minHeight = '5dvh';
   document.querySelector('#map-container').style.paddingBottom = '2rem';
   document.querySelector('#map').innerHTML = '';
   document.querySelector('#chart-combobox').style.display = 'none';
   document.querySelector('#chart-buttons').style.display = 'flex';
   document.querySelector('#chart-buttons').style.alignItems = 'center';
   document.querySelector('#no-map-message').classList.add('no-map-message-active');
...
if (typeof window !== 'undefined') {
  ...
  window.setNoChartsMapLayout = setNoChartsMapLayout;
}
